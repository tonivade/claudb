...
public class TinyDBResponseTest {

  @Test
  public void convertsString() {
    RedisToken token = TinyDBResponse.convert(string("test"));
  ...
  {
    RedisToken token = TinyDBResponse.convert(set(safeString("a"),
                                                  safeString("b"),
                                                  safeString("c")));
  ...
  {
    RedisToken token = TinyDBResponse.convert(list(safeString("a"),
                                                   safeString("b"),
                                                   safeString("c")));
  ...
  {
    RedisToken token = TinyDBResponse.convert(hash(entry(safeString("key1"), safeString("value1")),
  ...
  public void convertsZset() {
    RedisToken token = TinyDBResponse.convert(zset(score(1.0, safeString("a")),
  ...
  public void convertsNull() {
    RedisToken token = TinyDBResponse.convert((DatabaseValue) null);
