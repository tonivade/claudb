...
We’re using the simplified [Github workflow](https://docs.github.com/en/get-started/using-github/github-flow) to accept modifications, basically you’ll have to:
