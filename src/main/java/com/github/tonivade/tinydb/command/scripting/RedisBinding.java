...
public class RedisBinding
{
  private IRequest request;

  public RedisBinding(IRequest request)
  {
  ...
  {
    return request.getServerContext().getCommand(commandName.toString());
  }

  private Request createRequest(SafeString commandName, SafeString... params)
  {
    return new Request(request.getServerContext(), request.getSession(), commandName, asList(params));
  }
}
