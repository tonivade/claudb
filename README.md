...
You can start a new server listening in default port 7081.
    ...
    $ wget http://repo1.maven.org/maven2/com/github/tonivade/claudb/1.4.0/claudb-1.4.2-all.jar
    $ java -jar claudb-1.4.2-all.jar
...
Or gradle
    ...
    compile 'com.github.tonivade:claudb:1.4.2'
